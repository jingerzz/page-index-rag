...
Rate limiting: SEC allows max 10 requests/second. We use 0.15s delay (6.6 req/s)
plus jitter, with exponential backoff on 503 errors.
"""
...
# SEC rate limit: max 10 req/sec. Use 0.15s (6.6 req/s) + jitter for safety
SEC_DELAY = 0.15
JITTER_RANGE = (0.05, 0.15)  # Add 50-150ms random jitter
MAX_RETRIES = 3
